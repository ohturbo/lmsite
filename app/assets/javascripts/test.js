...
bgButton.addEventListener('click', function () {
	if (bgNumber == 0) {
		avatarView.style.backgroundImage = 'image-url(bg1.png)';
		bgNumber = 1;
	} else if (bgNumber == 1) {
		avatarView.style.backgroundImage = 'image-url(bg2.png)';
		bgNumber = 2;
	} else if (bgNumber == 2) {
		avatarView.style.backgroundImage = 'image-url(bg0.png)';
		bgNumber = 0;
	}
})
